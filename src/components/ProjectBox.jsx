...
function ProjectBox({ src, title, heading, logo }) {
  return (
    <div className="py-10">
      <div className="flex flex-col md:flex-row bg-gradient-to-r from-[#050505] via-[#000e2a] to-[#0c1b44] border border-white/20 rounded-3xl shadow-lg">
        ...
        <div className="flex-1 md:w-1/2 flex flex-col items-center md:items-start md:px-10">
          ...
          <div className="flex space-x-4 items-center my-20">
            <Avatar
              src={github}
              alt="GitHub Avatar"
              variant="rounded"
        ...
        {/* Right Section (Image) */}
        <div className="flex-1 md:w-1/2 md:pt-20">
          <img
            src={src}
            alt="Project Screenshot"
            className="w-full h-auto rounded-tl-3xl object-cover"
          />
        </div>
      </div>
    </div>
